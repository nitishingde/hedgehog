...
class CoreSwitch : public CoreQueueSender<GraphInputs> ... {
 ...
 private:
  ...
  /// @brief Slots accessors, throw an error, hedgehog switch does not have any slots
