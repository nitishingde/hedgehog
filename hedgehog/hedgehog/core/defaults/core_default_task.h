...
#endif //__clang//
/// @brief Middle class used to propose hedgehog default definition of CoreExecute::callExecute for CoreDefaultTask
...
class CoreDefaultTask
 ...
 public:
  ...
  /// @brief Defines what hedgehog CoreDefaultTask does before the execute loop
  ...
  /// @brief Defines what hedgehog CoreDefaultTask does after the execute loop
