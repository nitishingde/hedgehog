...
class CoreQueueSlot : public virtual CoreSlot {
 ...
 public:
  ...
  /// @brief Add hedgehog notifier to set of CoreNotifier
  ...
  /// @brief Remove hedgehog notifier from set of CoreNotifier
  /// @attention Thread safe
  ...
  /// @brief Wake up and notify hedgehog node connected to the condition variable CoreQueueSlot::notifyConditionVariable_
  void wakeUp() final {
