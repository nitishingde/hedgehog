...
/// @brief Receiver for nodes possessing hedgehog queue of data
...
class CoreQueueReceiver : public virtual CoreReceiver<NodeInput> {
 ...
 public:
  ...
  //Virtual
  /// @brief Queue slot accessor possessed by hedgehog CoreQueueMultiReceiver
  /// @return Queue slot possessed by hedgehog CoreQueueMultiReceiver
  ...
  /// @brief Add hedgehog CoreSender to this
  ...
  /// @brief Remove hedgehog CoreSender from this
  ...
  /// @brief Receive hedgehog data from hedgehog CoreQueueSender, and store it into the waiting queue
