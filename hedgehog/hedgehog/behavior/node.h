...
/// @details Node has hedgehog core, can add information to print in the dot file, and can define the way they terminate
class Node {
 public:
  /// @brief Core Accessor
  ...
  /// @attention Should override to break hedgehog cycle in hedgehog graph.
