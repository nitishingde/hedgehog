...
/// @details Visiting the graph's node following InputVisitor pattern
class AbstractPrinter {
 ...
 public:
  ...
  /// @param isMemoryManaged True if the edge hold hedgehog memory managed data, else False
  ...
  /// @brief Print the edges from the switch representation to hedgehog node
  ...
  /// @brief Accessor to check if hedgehog node has been visited by the printer
